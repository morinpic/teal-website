...
export const dummyNewsList: News[] = [
  ...
  },
  {
    ...
    eyecatch: { url: "https://placehold.jp/800x450.png", width: 800, height: 450 },
    tags: ["ヘアカラー", "トレンド"],
  },
  {
    id: "blog-2",
...
export const dummyStyleList: Style[] = [
  {
    ...
    revisedAt: now,
    title: "ナチュラルボブ",
    image: { url: "https://placehold.jp/600x800.png", width: 600, height: 800 },
    stylist: "橋本 貴広",
    menu: "カット",
...
export const dummyStaffList: Staff[] = [
  {
    ...
    photo: { url: "https://placehold.jp/400x400.png", width: 400, height: 400 },
