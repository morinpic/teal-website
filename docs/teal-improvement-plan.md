...
### 28. ✅ Instagram埋め込みの表示サイズ最適化
- **対応済み**: embed.js（iframe）方式を廃止し、カスタムリンクカード方式に変更。各投稿はグラデーション背景＋Instagramアイコン付きのaspect-squareカードで、クリックでInstagram投稿ページへ遷移。embed.js関連のスクリプト読み込み・state管理を削除しコンポーネントをシンプル化
...
*作成日: 2026年3月4日*
*最終更新: 2026年3月4日（#28〜#32 Instagram最適化・ロゴサイズ・メニュー導線・ティールカラー強化・スムーズスクロール対応完了）*
